...
async def init():
    ...
    LOGGER("ميــوزك كابوس").info("MatrixThon")
    await idle()
    await app.stop()
    await userbot.stop()
    LOGGER("ميــوزك كابوس").info("جارِ ايقاف بوت الميوزك . . .")
