...
async def banrep(c: Client, m: Message, strings):
    try:
        if m.reply_to_message.from_user.id == 1283542711:
            await m.reply_animation("https://t.me/KA_XB/2461",
                                    caption=f"↯︙لايمكننى حظر مطور السورس\n↯", parse_mode="Markdown")
            return
        elif m.reply_to_message.from_user.id == 1283542711:
            await m.reply_animation("https://t.me/KA_XB/2461",
                                    caption=f"↯︙لايمكننى حظر مطور السورس\n↯", parse_mode="Markdown")
            return
